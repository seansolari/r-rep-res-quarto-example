...
See @fig-hr for heart-rate based analysis.

(**Example 9**) Cortisol and Amylase Levels in Stress and Control Groups
...
plot <- generate_plot("output/data/preprocessed-GARP-TSST-data.csv")
plot
```

See @fig-cortisol for Cortisol and Amylase Levels in *Stress* and *Control* Groups.
...
::: columns
::: {.column width="50%"}
Left column content on the left
:::

::: {.column width="50%"}
Right column content on the right
:::
:::
